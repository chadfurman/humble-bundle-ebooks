...
A library for interacting with the Humble Bundle data cache.  This is the data cache that Humble Bundle loads client-side when you navigate your products.
