from graphene import ObjectType, List, Field, String, Float, Date, Int, Boolean, ID
# from database.dto.product import Product
...
class Bundle(ObjectType):
    ...
    # product=Field(Product, description="The metadata associated with this Bundle which HumbleBundle calls a Product")
