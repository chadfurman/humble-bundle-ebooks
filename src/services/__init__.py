""" Services used by the resolvers

###############
Services
###############

This is a set of classes for interacting with humblebundle.com bundles in various ways.
* The NetworkService is responsible for making and caching the remote API calls
